...
class Bubble {
    ...
    update(width, height, speed) {
        this.x += this.vx * speed * this.time.delta / 1000;
        this.y += this.vy * speed * this.time.delta / 1000;
...
export default class SceneBouncingBubbles extends Scene2D {
    ...
    update() {
        this.bubbles.forEach(bubble => bubble.update(this.width, this.height, this.params.speed));
        this.clear();
